...
public class SoulariumblockBlock extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:soulariumblock")
	public static final Block block = null;

	public SoulariumblockBlock(EnderIoRemakeModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("soulariumblock");
		}
