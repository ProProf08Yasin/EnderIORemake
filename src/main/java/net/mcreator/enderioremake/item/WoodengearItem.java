...
public class WoodengearItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:woodengear")
	public static final Item block = null;

	public WoodengearItem(EnderIoRemakeModElements instance) {
		super(instance, 84);
	}
