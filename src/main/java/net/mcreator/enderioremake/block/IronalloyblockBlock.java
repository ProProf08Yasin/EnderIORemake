...
public class IronalloyblockBlock extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:ironalloyblock")
	public static final Block block = null;

	public IronalloyblockBlock(EnderIoRemakeModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ironalloyblock");
		}
