...
public class SiliconItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:silicon")
	public static final Item block = null;

	public SiliconItem(EnderIoRemakeModElements instance) {
		super(instance, 92);
	}
