...
public class IronalloynuggetItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:ironalloynugget")
	public static final Item block = null;

	public IronalloynuggetItem(EnderIoRemakeModElements instance) {
		super(instance, 58);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ironalloynugget");
		}
