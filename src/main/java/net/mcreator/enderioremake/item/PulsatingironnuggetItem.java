...
public class PulsatingironnuggetItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:pulsatingironnugget")
	public static final Item block = null;

	public PulsatingironnuggetItem(EnderIoRemakeModElements instance) {
		super(instance, 53);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("pulsatingironnugget");
		}
