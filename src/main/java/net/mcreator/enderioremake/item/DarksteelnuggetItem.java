...
public class DarksteelnuggetItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:darksteelnugget")
	public static final Item block = null;

	public DarksteelnuggetItem(EnderIoRemakeModElements instance) {
		super(instance, 55);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("darksteelnugget");
		}
