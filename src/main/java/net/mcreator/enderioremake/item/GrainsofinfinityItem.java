...
public class GrainsofinfinityItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:grainsofinfinity")
	public static final Item block = null;

	public GrainsofinfinityItem(EnderIoRemakeModElements instance) {
		super(instance, 13);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("grainsofinfinity");
		}
