...
public class ConductiveironblockBlock extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:conductiveironblock")
	public static final Block block = null;

	public ConductiveironblockBlock(EnderIoRemakeModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("conductiveironblock");
		}
