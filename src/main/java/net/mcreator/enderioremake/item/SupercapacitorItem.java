...
public class SupercapacitorItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:supercapacitor")
	public static final Item block = null;

	public SupercapacitorItem(EnderIoRemakeModElements instance) {
		super(instance, 49);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("supercapacitor");
		}
