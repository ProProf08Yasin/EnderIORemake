...
public class SoulariumingotItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:soulariumingot")
	public static final Item block = null;

	public SoulariumingotItem(EnderIoRemakeModElements instance) {
		super(instance, 10);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("soulariumingot");
		}
