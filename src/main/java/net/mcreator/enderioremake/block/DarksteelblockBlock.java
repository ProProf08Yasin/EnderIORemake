...
public class DarksteelblockBlock extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:darksteelblock")
	public static final Block block = null;

	public DarksteelblockBlock(EnderIoRemakeModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darksteelblock");
		}
