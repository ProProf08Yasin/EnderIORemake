...
public class SoulariumnuggetItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:soulariumnugget")
	public static final Item block = null;

	public SoulariumnuggetItem(EnderIoRemakeModElements instance) {
		super(instance, 51);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("soulariumnugget");
		}
