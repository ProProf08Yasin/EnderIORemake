...
public class VibrantalloynuggetItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:vibrantalloynugget")
	public static final Item block = null;

	public VibrantalloynuggetItem(EnderIoRemakeModElements instance) {
		super(instance, 50);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("vibrantalloynugget");
		}
