...
public class InfinitybimetalgearItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:infinitybimetalgear")
	public static final Item block = null;

	public InfinitybimetalgearItem(EnderIoRemakeModElements instance) {
		super(instance, 82);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("infinitybimetalgear");
		}
