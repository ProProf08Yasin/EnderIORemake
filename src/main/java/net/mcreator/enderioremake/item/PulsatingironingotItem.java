...
public class PulsatingironingotItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:pulsatingironingot")
	public static final Item block = null;

	public PulsatingironingotItem(EnderIoRemakeModElements instance) {
		super(instance, 5);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("pulsatingironingot");
		}
