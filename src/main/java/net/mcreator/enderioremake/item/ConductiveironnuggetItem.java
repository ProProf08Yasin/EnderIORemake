...
public class ConductiveironnuggetItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:conductiveironnugget")
	public static final Item block = null;

	public ConductiveironnuggetItem(EnderIoRemakeModElements instance) {
		super(instance, 54);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("conductiveironnugget");
		}
