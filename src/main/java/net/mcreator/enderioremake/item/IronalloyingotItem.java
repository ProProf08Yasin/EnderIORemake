...
public class IronalloyingotItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:ironalloyingot")
	public static final Item block = null;

	public IronalloyingotItem(EnderIoRemakeModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ironalloyingot");
		}
