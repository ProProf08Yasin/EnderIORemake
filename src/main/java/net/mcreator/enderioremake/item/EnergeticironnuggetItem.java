...
public class EnergeticironnuggetItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:energeticironnugget")
	public static final Item block = null;

	public EnergeticironnuggetItem(EnderIoRemakeModElements instance) {
		super(instance, 57);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("energeticironnugget");
		}
