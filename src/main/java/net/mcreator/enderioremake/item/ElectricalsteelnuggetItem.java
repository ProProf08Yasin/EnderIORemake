...
public class ElectricalsteelnuggetItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:electricalsteelnugget")
	public static final Item block = null;

	public ElectricalsteelnuggetItem(EnderIoRemakeModElements instance) {
		super(instance, 56);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("electricalsteelnugget");
		}
