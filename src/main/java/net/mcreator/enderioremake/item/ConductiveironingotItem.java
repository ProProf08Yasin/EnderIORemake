...
public class ConductiveironingotItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:conductiveironingot")
	public static final Item block = null;

	public ConductiveironingotItem(EnderIoRemakeModElements instance) {
		super(instance, 6);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("conductiveironingot");
		}
