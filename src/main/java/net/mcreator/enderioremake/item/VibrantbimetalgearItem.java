...
public class VibrantbimetalgearItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:vibrantbimetalgear")
	public static final Item block = null;

	public VibrantbimetalgearItem(EnderIoRemakeModElements instance) {
		super(instance, 80);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("vibrantbimetalgear");
		}
