...
public class RedstonealloyblockBlock extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:redstonealloyblock")
	public static final Block block = null;

	public RedstonealloyblockBlock(EnderIoRemakeModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redstonealloyblock");
		}
