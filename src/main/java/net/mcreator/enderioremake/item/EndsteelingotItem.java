...
public class EndsteelingotItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:endsteelingot")
	public static final Item block = null;

	public EndsteelingotItem(EnderIoRemakeModElements instance) {
		super(instance, 11);
	}
