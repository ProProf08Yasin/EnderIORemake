...
public class SoulvialItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:soulvial")
	public static final Item block = null;

	public SoulvialItem(EnderIoRemakeModElements instance) {
		super(instance, 98);
	}
