...
public class RedstonealloyingotItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:redstonealloyingot")
	public static final Item block = null;

	public RedstonealloyingotItem(EnderIoRemakeModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("redstonealloyingot");
		}
