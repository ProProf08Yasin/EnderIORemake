...
public class EndsteelblockBlock extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:endsteelblock")
	public static final Block block = null;

	public EndsteelblockBlock(EnderIoRemakeModElements instance) {
		super(instance, 17);
	}
