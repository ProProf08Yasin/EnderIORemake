...
import net.mcreator.enderioremake.gui.AlloysmelterguiGui;
...
public class AlloysmelterBlock extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:alloysmelter")
	public static final Block block = null;

	public AlloysmelterBlock(EnderIoRemakeModElements instance) {
		super(instance, 24);
	}
