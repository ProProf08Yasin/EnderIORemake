...
public class BasicitemfilterItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:basicitemfilter")
	public static final Item block = null;

	public BasicitemfilterItem(EnderIoRemakeModElements instance) {
		super(instance, 99);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("basicitemfilter");
		}
