...
public class RedstonealloynuggetItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:redstonealloynugget")
	public static final Item block = null;

	public RedstonealloynuggetItem(EnderIoRemakeModElements instance) {
		super(instance, 52);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("redstonealloynugget");
		}
