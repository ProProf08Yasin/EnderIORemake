...
public class ImprovedcapacitorItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:improvedcapacitor")
	public static final Item block = null;

	public ImprovedcapacitorItem(EnderIoRemakeModElements instance) {
		super(instance, 48);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("improvedcapacitor");
		}
