...
public class BasiccapacitorItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:basiccapacitor")
	public static final Item block = null;

	public BasiccapacitorItem(EnderIoRemakeModElements instance) {
		super(instance, 47);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("basiccapacitor");
		}
