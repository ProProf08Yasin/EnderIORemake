...
public class ElectricalsteelingotItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:electricalsteelingot")
	public static final Item block = null;

	public ElectricalsteelingotItem(EnderIoRemakeModElements instance) {
		super(instance, 9);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("electricalsteelingot");
		}
