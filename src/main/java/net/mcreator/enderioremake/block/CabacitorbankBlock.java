...
public class CabacitorbankBlock extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:cabacitorbank")
	public static final Block block = null;
	@ObjectHolder("ender_io_remake:cabacitorbank")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public CabacitorbankBlock(EnderIoRemakeModElements instance) {
		super(instance, 101);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("cabacitorbank"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("cabacitorbank");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Cabacitor bank");
		}
