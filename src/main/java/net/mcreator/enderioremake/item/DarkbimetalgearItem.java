...
public class DarkbimetalgearItem extends EnderIoRemakeModElements.ModElement {
	@ObjectHolder("ender_io_remake:darkbimetalgear")
	public static final Item block = null;

	public DarkbimetalgearItem(EnderIoRemakeModElements instance) {
		super(instance, 79);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("darkbimetalgear");
		}
